...
def render(starterlist: dict, filename: str):
    ...
    if logo_path and os.path.exists(logo_path):
        try:
            ...
            print(f"WORD DRE 5 LOGO DEBUG: Logo positioned at top right: {logo_path}")
        except Exception as e:
            print(f"WORD DRE 5 LOGO DEBUG: Logo error: {e}")
    ...
    for group_num in sorted(starters_by_group.keys()):
        ...
        for starter_idx, starter in enumerate(group_starters):
            ...
            if rider_name:
                content_parts.append(rider_name.upper())  # KEINE Änderung hier - bleibt UPPER
