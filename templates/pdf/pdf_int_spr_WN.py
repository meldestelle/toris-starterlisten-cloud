# -*- coding: utf-8 -*-
# templates/pdf/pdf_int_spr_WN.py - International Springen 1 Umlauf - mit printOptions-Unterstützung
...
def render(starterlist, filename, logo_max_width_cm=5.0):
    ...
    # Header (7 Spalten: #, CNO, Horse, Athlete, Nat., Points, Time)
    data_texts.append(["#", "CNO", "Horse", "Athlete", "Nat.", "Result"])
    ...
    # 7 Spalten: #, CNO, Horse, Athlete, Nat., Points, Time
    result_col = 20*mm
    athlete_col = 48*mm
    col_widths = [10*mm, 12*mm, page_width - 10*mm - 12*mm - athlete_col - 13*mm - result_col, athlete_col, 13*mm, result_col]
