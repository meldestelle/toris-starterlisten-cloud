# -*- coding: utf-8 -*-
# templates/pdf/pdf_std_spr_2UML.py - Nationales Springen 2 Umläufe - mit printOptions-Unterstützung
...
def render(starterlist, filename, logo_max_width_cm=5.0):
    ...
    data_texts.append(["#", "KNR", "Pferd", "Reiter", "Nat.", "1.Rd", "2.Rd", "Total"])
    ...
    # Spaltenbreiten
    # 8 Spalten: #, KNR, Pferd, Reiter, Nat., 1.Rd, 2.Rd, Total
    result_col = 15*mm
    total_col = 15*mm
    athlete_col = 48*mm
