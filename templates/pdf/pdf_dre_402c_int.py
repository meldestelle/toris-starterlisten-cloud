# -*- coding: utf-8 -*-
# templates/pdf/pdf_dre_402c_int.py - Speziell für Richtverfahren 402.C - mit printOptions-Unterstützung
...
def render(starterlist: dict, filename: str, logo_max_width_cm: float = 5.0):
    ...
    if judges:
        title = f"Judges ({judging_rule})" if judging_rule else "Judges"
