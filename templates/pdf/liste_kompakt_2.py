# templates/stream/liste_kompakt_2.py
...
def render(starterlist: dict, filename: str):
    ...
    # Erstelle Custom DocTemplate mit alternierenden Seitenvorlagen
    class ListeDocTemplate(SimpleDocTemplate):
        def __init__(self, filename, **kw):
            ...
            frame_front = Frame(
                ...
                A4[0] - 18*mm, A4[1] - top_margin_front*mm - bottom_margin_front*mm,
                id='front',
            ...
            frame_back = Frame(
                ...
                A4[0] - 18*mm, A4[1] - top_margin_back*mm - bottom_margin_back*mm,
                id='back',
                leftPadding=0, rightPadding=0, topPadding=0, bottomPadding=0
            )
