# -*- coding: utf-8 -*-
# templates/pdf/pdf_int_spr_breeder.py - International Springen Breeder Design - mit printOptions-Unterstützung
...
def render(starterlist, filename, logo_max_width_cm=5.0):
    ...
    if logo_path and os.path.exists(logo_path):
        try:
            ...
            header_table = Table(header_table_data, colWidths=[page_width - logo_col_width, logo_col_width])
