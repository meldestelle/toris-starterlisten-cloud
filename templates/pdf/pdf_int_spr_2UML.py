# -*- coding: utf-8 -*-
# templates/pdf/pdf_int_spr_2UML.py - International Springen 2 Umläufe - mit printOptions-Unterstützung
...
def render(starterlist, filename, logo_max_width_cm=5.0):
    ...
    # Header (8 Spalten: #, CNO, Horse, Athlete, Nat., 1.Rd, 2.Rd, Total)
    data_texts.append(["#", "CNO", "Horse", "Athlete", "Nat.", "1.Rd", "2.Rd", "Total"])
    ...
    # 8 Spalten: #, CNO, Horse, Athlete, Nat., 1.Rd, 2.Rd, Total
    result_col = 15*mm
    total_col = 15*mm
    athlete_col = 48*mm  # 48mm damit horse_col gleich wie 2ph → Athlete-Header bündig
    col_widths = [10*mm, 12*mm, page_width - 10*mm - 12*mm - athlete_col - 13*mm - 2*result_col - total_col, athlete_col, 13*mm, result_col, result_col, total_col]
    ...
    ts = TableStyle([
        ...
        # Athlete-Header: leftIndent in style_hdr_athlete übernimmt die Positionierung
