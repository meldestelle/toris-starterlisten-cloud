...
def render(starterlist: dict, filename: str, logo_max_width_cm: float = 5.0):
    ...
    if judges:
        ...
        if c_judges:
            ...
            judges_para = Paragraph(f"<b>Richter:</b> {judges_text}", style_sub)
    ...
    data_texts.append([
        "<b># / KNr</b>", 
        "<b>Reiter / Pferd</b><br/><font size=7>Geschlecht / Farbe / Geboren / Vater x Muttervater / Besitzer / Züchter</font>", 
    ...
    # Spaltenbreiten definieren - MIT NAT-SPALTE, Start+KNr kombiniert (page_width wurde oben berechnet)
