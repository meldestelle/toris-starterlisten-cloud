# -*- coding: utf-8 -*-
# templates/stream/liste_dre_5_2.py
...
def render(starterlist: dict, filename: str):
    ...
    # --- TABELLE MIT 5 RICHTER-SPALTEN (9 Spalten total) MIT GRUPPIERUNGSLOGIK ---
    starters = starterlist.get("starters") or []
    ...
    # --- Tabelle erstellen (9 Spalten) ---
    page_width = A4[0] - 16*mm  # 8mm links + 8mm rechts
    col1 = 18*mm
    col2 = 16*mm      # KoNr. breiter gemacht (von 12mm auf 16mm)
    col_judge = 12*mm
    col_total = 15*mm
    col3 = page_width - col1 - col2 - (5*col_judge) - col_total
    col_widths = [col1, col2, col3, col_judge, col_judge, col_judge, col_judge, col_judge, col_total]
