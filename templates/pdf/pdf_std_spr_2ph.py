# -*- coding: utf-8 -*-
# templates/pdf/pdf_std_spr_2ph.py - Nationales Springen Zwei-Phasen - mit printOptions-Unterstützung
...
def render(starterlist, filename, logo_max_width_cm=5.0):
    ...
    data_texts.append(["#", "KNR", "Pferd", "Reiter", "Nat.", "Phase 1", "Phase 2", "Total"])
    ...
    # Spaltenbreiten
    # 8 Spalten: #, KNR, Pferd, Reiter, Nat., Phase 1, Phase 2, Total
    result_col = 16*mm
    athlete_col = 48*mm
