# -*- coding: utf-8 -*-
# templates/pdf/pdf_dre_3_int.py - mit printOptions-Unterstützung
...
def render(starterlist: dict, filename: str, logo_max_width_cm: float = 5.0):
    ...
    if needs_custom_margins:
        ...
        # Bottom: Sponsorenpapier-Wert ODER Mindesthöhe für Sponsorenleiste
    ...
    # Logo + Header nur wenn Prüfungskopf angezeigt wird
    ...
    # Logo + Header in Tabelle (Text links, Logo rechts)
    ...
    if 0 in breaks_by_after:
        for br in breaks_by_after[0]:
            ...
            data_texts.append([pause_text, "", "", "", "", "", ""])  # 7 Spalten (3 Richter)
    ...
    # Spaltenbreiten - MIT NAT-SPALTE, Start+KNr kombiniert (page_width wurde oben berechnet)
    ...
    if judges:
        title = "Judges" + (f" ({judging_rule})" if judging_rule else "")
